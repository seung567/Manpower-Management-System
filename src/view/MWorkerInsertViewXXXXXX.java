...
public class MWorkerInsertViewXXXXXX extends JFrame {
	...
	public static void workerInsertAction() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					// 기본 프레임 명령어
					MWorkerInsertViewXXXXXX frame = new MWorkerInsertViewXXXXXX();
	 ...
	 * Create the frame.
	 */
	public MWorkerInsertViewXXXXXX() {
...
//				new MReqContInsertView().Action();
	...
	public MWorkerInsertViewXXXXXX getInstance() {
		return this;
	}
}
